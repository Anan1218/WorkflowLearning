...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  rlink: {
    term: "RLink",
    def: "RLI's online platform for high-volume transactional commercial surety — automated underwriting with streamlined rating, submission, and issuance.",
  },
  mybondapp: {
    term: "MyBondApp",
  ...
  quickwrite: {
    term: "QuickWrite",
    def: "RLI's online quote/bind/servicing platform on the P&C construction side — notable here because it confirms RLI already runs agency downloads to Applied, AMS360, and HawkSoft.",
  },
  ...
  principal: {
    term: "Principal",
    def: "The business whose obligation the bond guarantees — in contract surety, usually the contractor applying for the bond.",
  },
  obligee: {
    term: "Obligee",
  ...
  "under/over-billing": {
    ...
    def: "Underbilling = the contractor earned more than it billed (can strain cash). Overbilling = billed ahead of the work (a liability — some collected cash belongs to future work). Underwriters read this column closely.",
  },
  "working capital": {
  ...
  clearance: {
    term: "Clearance",
    aliases: ["dedup"],
    def: "The carrier's check that a submission or account hasn't already been received from another agent — prevents duplicate competing files and determines which producer controls the account.",
  },
  appetite: {
    term: "Appetite",
  ...
  referral: {
    term: "Referral",
    aliases: ["referrals"],
    def: "A case the automated underwriting rules couldn't clear — kicked out of the straight-through flow for a human underwriter to review.",
  },
  "straight-through": {
  ...
  "automated underwriting": {
    ...
    def: "Rule- and score-based decisioning (often credit-driven) that approves, rates, and issues eligible bonds without an underwriter — how RLink handles high-volume transactional surety.",
  },
  "fast-track": {
    term: "Fast-track",
  ...
  underwriter: {
    term: "Underwriter",
    def: "The carrier-side decision maker who evaluates a submission and decides whether — and on what terms — to issue the bond.",
  },
  carrier: {
    term: "Carrier",
  ...
  npi: {
    term: "NPI",
    def: "Nonpublic Personal Information under the Gramm-Leach-Bliley Act (GLBA): private financial and identity data a financial institution holds — owner credit, personal financials, tax data. Triggers safeguarding obligations wherever it flows.",
  },
  pii: {
    term: "PII",
  ...
  dpa: {
    term: "DPA",
    def: "Data Processing Agreement: the contract defining how a vendor may handle customer data — permitted use, security, breach duties, deletion, audit rights. Required for every subprocessor.",
  },
  "soc 2": {
    term: "SOC 2",
  ...
  lineage: {
    term: "Lineage",
    def: "Tracing every extracted field back to the exact source document and system it came from — the answer to an auditor's 'where did this number come from?'",
  },
  // ---- external sources ----
  "d&b": {
    term: "D&B",
  ...
  "994f": {
    ...
    def: "SBA's Schedule of Work in Process — the standardized WIP form (Form 994 is the guarantee application itself). The SBA even accepts WIP as a machine-readable XBRL spreadsheet.",
  },
  xbrl: {
    term: "XBRL",
  ...
  acord: {
    term: "ACORD",
    def: "The insurance industry's standardized forms (applications, certificates) used to exchange information between agencies and carriers — a common shape for incoming submission documents.",
  },
  fein: {
    term: "FEIN",
  ...
  evals: {
    ...
    def: "Automated evaluations: running the extractor over labeled documents and scoring per-field accuracy, latency, and cost. Run before every change — it's the evidence engine behind every claim here.",
  },
  ocr: {
    term: "OCR",
    def: "Optical Character Recognition — turning scanned images into text. Scanned/handwritten documents need an OCR + image hybrid step; this demo handles digital text and text-layer PDFs.",
  },
  otel: {
    term: "OTel → Langfuse",
    aliases: ["OTel", "Langfuse"],
    def: "OpenTelemetry (the open tracing standard) shipping every model call — prompt, tokens, cost, latency — to Langfuse for inspection. Self-hostable inside a carrier's walls so no document content leaves.",
  },
  "instructor + pydantic": {
